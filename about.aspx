...
<body>
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="downloads.aspx"><b>Downloads</b><img src="images/new.gif" /></a></li>
                         <li class="active"><a href="about.aspx"><b>About Us</b></a></li>
	...
	<div class="container">
        ...
        <div class="jumbotron" style="background-color:transparent; margin-bottom:-100px;">
            <p>Techz Solution is a techinal website which is design to provides next-generation, Techincal  support services for Non-techincal individuls. We provide support coverage extends to technologies that we use every day. </p>
            <p>Techz Solution comprehensive support coverage spans across wimdows applications, servers, hardware devices, Android Phone, peripherals, Linux .</p>
            <p>Techz Solution combines superior talent with proprietary technology to deliver the best technical support service through Website. Techz Solution knowledge database grows with every interaction by documenting the problem, its solution and the specifications of the computer hardware, software and all peripherals.</p>
            <p>Techz Solution personalization engine captures the customer's demographic information and his/her behavioral profile.</p>
            <p>We provide PC optimization, OS downloading and troubleshooting for errors. Users can contact us through form submission in case of queries and other problems.</p>
        </div>
    </div>
        <!--footer-->
